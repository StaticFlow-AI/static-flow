...
| Reillyhhh | unknown | unknown | 1000 (subscription metadata only) | unknown | `laohan143` (operator-skipped after GitHub password rotation completed; the Kiro token was not refreshed and the existing account remains disabled with `auth_401`) |
